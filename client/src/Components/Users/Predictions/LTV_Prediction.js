...
componentDidMount(){
  ...
  <div class="page-content fade-in-up">
        <h1 style={{textAlign:'center'}}><u>Customer Lifetime Value Analysis</u></h1>
        {this.state.uploaded?
        <>
        {
        ...
        <h3 class="text-danger" style={{textAlign:'center',marginTop:20}}>Customer Lifetime Value Analysis Running Please Wait..... </h3>
